    ...
    <div className="relative pointer-events-auto">
      <button
        ...
        title={
          isFa
            ? isPlaying
              ? (isNight ? 'در حال پخش جاز آرامش‌بخش شب (کلیک برای توقف)' : 'در حال پخش صدای ملایم شرکت (کلیک برای توقف)')
              : (isNight ? 'خاموش (کلیک برای پخش جاز آرامش‌بخش شب)' : 'خاموش (کلیک برای پخش صدای ملایم شرکت)')
            : isPlaying
              ? (isNight ? 'Playing relaxing night jazz (Click to pause)' : 'Playing office ambience (Click to pause)')
              : (isNight ? 'Muted (Click to play night jazz)' : 'Muted (Click to play office ambience)')
        }
      >
